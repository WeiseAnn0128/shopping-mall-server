...
public class SysHelpInformationController extends BaseController
{
    ...
    @Log(title = "帮助信息表的增删查改", businessType = BusinessType.EXPORT)
    @GetMapping("/export")
    public AjaxResult export(SysHelpInformation sysHelpInformation)
    {
        ...
        return util.exportExcel(list, "帮助信息表的增删查改数据");
    }
    ...
    @Log(title = "帮助信息表的增删查改", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "帮助信息表的增删查改", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "帮助信息表的增删查改", businessType = BusinessType.DELETE)
