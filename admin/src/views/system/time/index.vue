<template>
 ...
 <!--     <el-form-item label="签到时间" prop="creatTime">
...
<!--      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="timeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="签到时间" align="center" prop="creatTime" width="180">
...
<script>
import { listTime, getTime, delTime, addTime, updateTime, exportTime } from "@/api/system/time";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除签到时间编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有签到时间数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
