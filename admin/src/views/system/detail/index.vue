  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="商品详情图" prop="detailImg">
        <el-input
          v-model="queryParams.detailImg"
          placeholder="请输入商品详情图"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="detailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商品详情图" align="center" prop="id" />
      ...
      <el-table-column label="商品详情图" align="center" prop="detailImg" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="顶部图片" prop="topImg">
          <el-input v-model="form.topImg" placeholder="请输入顶部图片" />
        </el-form-item>
        <el-form-item label="商品详情图" prop="detailImg">
          <el-input v-model="form.detailImg" placeholder="请输入商品详情图" />
        </el-form-item>
      </el-form>
